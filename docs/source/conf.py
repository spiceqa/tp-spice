# -*- coding: utf-8 -*-
#
# tp-spice documentation build configuration file, created by
...
# your module, it must be importable. That means that the module or the package
# must be in one of the directories on sys.path – adapt your sys.path in the
# configuration file accordingly.
import_path = []
import_path.insert(0, ("..", ".."))
import_path.insert(0, ("..", "..", "spice"))
import_path.insert(0, ("..", "..", "spice", "tests"))
...
project = u'tp-spice'
copyright = u'2016, Andrei Stepanov'
